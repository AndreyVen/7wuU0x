Vendetta version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vendetta/files/Vendetta/vendetta-0.5.4/
...
http://gitorious.org/vendetta/vendettad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vendetta-Qt notifications under Growl 1.3.
Increase required age of Vendetta-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVendetta properly when installing Vendetta-Qt over it. (Windows)
