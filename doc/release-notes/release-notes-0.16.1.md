Vendetta Core version 0.16.1 is now available from:

  <https://vendettacore.org/bin/vendetta-core-0.16.1/>
...
- #12843 `df38b13` Test starting vendettad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure vendettad processes are cleaned up when tests end (sdaftuar)
