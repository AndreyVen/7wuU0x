Vendetta Core version 0.9.2.1 is now available from:

  https://vendetta.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VEN to 0.01 VEN
...
- Fix "Start vendetta on system login"
