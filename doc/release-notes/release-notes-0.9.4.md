Vendetta Core version 0.9.4 is now available from:

  https://vendetta.org/bin/0.9.4/
...
this update is incompatible with the Vendetta system and could lead to consensus
forks.

Vendetta Core released binaries from https://vendetta.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~vendetta/+archive/ubuntu/vendetta
- A third-party or self-compiled Vendetta Core

upgrade to Vendetta Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
