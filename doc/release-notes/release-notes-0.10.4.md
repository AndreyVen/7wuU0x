Vendetta Core version 0.10.4 is now available from:

  <https://vendetta.org/bin/vendetta-core-0.10.4/>
...
- #6953 `43c2789` Split vendetta-tx into its own package
- #6953 `dfe0d4d` Include vendetta-tx binary on Debian/Ubuntu
