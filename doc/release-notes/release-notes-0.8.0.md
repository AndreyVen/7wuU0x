Vendetta-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vendetta/files/Vendetta/vendetta-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vendetta
...
New/changed settings (command-line or vendetta.conf file)
--------------------------------------------------------
