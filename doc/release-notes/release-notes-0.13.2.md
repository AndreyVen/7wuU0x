Vendetta Core version 0.13.2 is now available from:

  <https://vendetta.org/bin/vendetta-core-0.13.2/>
...
- #8908 `4a974b2` Update vendetta-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow vendetta-tx to create v2 transactions (vendrak)
