...
* vendetta.conf: contains configuration settings for vendettad or vendetta-qt
* vendettad.pid: stores the process id of vendettad while running
...
* debug.log: contains debug information and general logging generated by vendettad or vendetta-qt
