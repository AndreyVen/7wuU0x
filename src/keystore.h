...
#ifndef VENDETTA_KEYSTORE_H
#define VENDETTA_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/vendetta/bips/blob/master/bip-0013.mediawiki
