 ...
 */
#ifndef VENDETTA_UTIL_H
#define VENDETTA_UTIL_H
...
extern const char * const VENDETTA_CONF_FILENAME;
extern const char * const VENDETTA_PID_FILENAME;
...
{
    std::string s = strprintf("vendetta-%s", name);
