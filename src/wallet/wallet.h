...
#ifndef VENDETTA_WALLET_WALLET_H
#define VENDETTA_WALLET_WALLET_H
...
public:
     ...
     * on this vendetta node, and set to 0 for transactions that were created
...
#endif // VENDETTA_WALLET_WALLET_H
