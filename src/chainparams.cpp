...
{
    const char* pszTimestamp = "The best chain should have at least this much work.";
    const CScript genesisOutputScript = CScript() << ParseHex("049144e723a777f891c17a52f538f81a0629b41c9ca67a131c6b091983f2e63c2efda8ed3110c847953143337578eb95e53977d46296095ce17561f780a4131b94") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0x000000009addc8a4515cbd7bd72b74428809eb848bb1f1eeb5aac7c9fc243d1f");
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = uint256S("0x000000009addc8a4515cbd7bd72b74428809eb848bb1f1eeb5aac7c9fc243d1f");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1557777224, 873776243, 0x1d00ffff, 1, 50 * COIN);
//MineGenesis(genesis, consensus.powLimit, true);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x"));
        assert(genesis.hashMerkleRoot == uint256S("0x"));
        ...
        vSeeds.emplace_back("192.168.0.167");
        vSeeds.emplace_back("192.168.0.15");
