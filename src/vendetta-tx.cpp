...
static void SetupVendettaTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vendetta-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vendetta-tx [options] <hex-tx> [commands]  Update hex-encoded vendetta transaction\n" +
            "or:     vendetta-tx [options] -create [commands]   Create hex-encoded vendetta transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vendetta transaction
