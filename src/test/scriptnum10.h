...
#ifndef VENDETTA_TEST_SCRIPTNUM10_H
#define VENDETTA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Vendetta Core 0.10.0, for cross-comparison.
 */
public:
