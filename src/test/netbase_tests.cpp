...
{
    BOOST_CHECK(TestSplitHost("www.vendettacore.org", "www.vendettacore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.vendettacore.org]", "www.vendettacore.org", -1));
    BOOST_CHECK(TestSplitHost("www.vendettacore.org:80", "www.vendettacore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.vendettacore.org]:80", "www.vendettacore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10002", "127.0.0.1", 10002));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10002", "127.0.0.1", 10002));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10002", "::ffff:127.0.0.1", 10002));
    BOOST_CHECK(TestSplitHost("[::]:10002", "::", 10002));
    BOOST_CHECK(TestSplitHost("::10002", "::10002", -1));
    BOOST_CHECK(TestSplitHost(":10002", "", 10002));
    BOOST_CHECK(TestSplitHost("[]:10002", "", 10002));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10002", "127.0.0.1:10002"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10002", "[::]:10002"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
