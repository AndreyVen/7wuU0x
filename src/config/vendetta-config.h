/* src/config/vendetta-config.h.  Generated from vendetta-config.h.in by configure.  */
/* src/config/vendetta-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VENDETTA_CONFIG_H

#define VENDETTA_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Vendetta Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Vendetta Core"
...
#define PACKAGE_BUGREPORT "https://github.com/vendetta/vendetta/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vendetta Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vendetta Core 0.17.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vendetta"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://vendettacore.org/"
