...
#ifndef VENDETTA_QT_VENDETTAUNITS_H
#define VENDETTA_QT_VENDETTAUNITS_H
...
/** Vendetta unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VendettaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VendettaUnits(QObject *parent);

    /** Vendetta units.
      @note Source: https://en.vendetta.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        VEN,
...
typedef VendettaUnits::Unit VendettaUnit;

#endif // VENDETTA_QT_VENDETTAUNITS_H
