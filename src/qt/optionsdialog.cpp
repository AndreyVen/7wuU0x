    ...
    mapper(0)
{
    ...
    ui->vendettaAtStartup->setToolTip(ui->vendettaAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->vendettaAtStartup->setText(ui->vendettaAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openVendettaConfButton->setToolTip(ui->openVendettaConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new VendettaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vendettaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVendettaConfButton_clicked()
{
