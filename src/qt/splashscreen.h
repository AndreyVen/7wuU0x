...
#ifndef VENDETTA_QT_SPLASHSCREEN_H
#define VENDETTA_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Vendetta Core initialization
...
#endif // VENDETTA_QT_SPLASHSCREEN_H
