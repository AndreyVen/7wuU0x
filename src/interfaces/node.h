...
#ifndef VENDETTA_INTERFACES_NODE_H
#define VENDETTA_INTERFACES_NODE_H
...
//! Top-level interface for a vendetta node (vendettad process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // VENDETTA_INTERFACES_NODE_H
