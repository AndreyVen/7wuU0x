...
class BIP66Test(VendettaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # vendettad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and vendettad produces more specific reject
            # reasons.
