...
# TestP2PConn: A peer we use to send messages to vendettad, and store responses.
...
class CompactBlocksTest(VendettaTestFramework):
    ...
    # This test actually causes vendettad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that vendettad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for vendettad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # vendettad will not send blocktxn responses for blocks whose height is
