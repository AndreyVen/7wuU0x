...
"""Verify that starting vendetta with -h works as expected."""

from test_framework.test_framework import VendettaTestFramework
from test_framework.util import assert_equal

class HelpTest(VendettaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vendetta with -h for help text")
        ...
        self.log.info("Start vendetta with -version for version information")
        ...
        self.log.info("Start vendettad with -fakearg to make sure it does not start")
